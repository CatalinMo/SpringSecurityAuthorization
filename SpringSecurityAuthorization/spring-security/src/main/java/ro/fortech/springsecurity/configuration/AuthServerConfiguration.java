...
public class AuthServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    @Value("${user.oauth.custom-client2.clientId}")
    private String ClientID2;
    @Value("${user.oauth.custom-client2.clientSecret}")
    private String ClientSecret2;
    @Value("${user.oauth.custom-client2.redirectUris}")
    private String RedirectURLs2;
